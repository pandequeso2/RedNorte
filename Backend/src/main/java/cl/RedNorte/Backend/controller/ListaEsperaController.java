...
public class ListaEsperaController {
    ...
    public ResponseEntity<SolicitudEspera> registrarSolicitud(@RequestBody SolicitudEspera solicitud) {
        return ResponseEntity.ok(listaEsperaService.crearSolicitud(solicitud));
    }

    @GetMapping("/criticos")
    @Operation(summary = "Obtener pacientes con mayor tiempo de espera", description = "Resuelve el problema de pacientes estancados [cite: 15]")
    ...
    @Operation(summary = "Consultar estado para el Portal del Paciente [cite: 24]")
